import { Cas2HdcAssessmentStatusUpdate, Cas2HdcUpdateAssessment } from '@approved-premises/api'
...
describe('AssessmentService', () => {
  ...
  describe('updateAssessment', () => {
    it('calls the update method and returns an assessment', async () => {
      ...
      const updateData: Cas2HdcUpdateAssessment = {
  ...
  describe('updateAssessmentstatus', () => {
    it('calls the update status client method', async () => {
      ...
      const newStatus: Cas2HdcAssessmentStatusUpdate = {
